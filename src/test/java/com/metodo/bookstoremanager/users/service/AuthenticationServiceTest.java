...
public class AuthenticationServiceTest {
    ...
    @Test
    void whenUsernameAndPasswordIsInformedThenAnTokenShouldBeGenerated() {
        ...
        JwtResponse generatedTokenResponse = authenticationService.createdAuthenticationToken(jwtRequest);
